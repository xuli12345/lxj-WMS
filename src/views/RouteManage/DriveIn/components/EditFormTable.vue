<template>
  <div>
    ...
    <!-- 出车登记需要填写出车时里程数 -->
    <el-dialog title="回车登记" :visible.sync="dialogFormVisible" :modal="false">
      <el-form :model="form"  style="width:100%" :rules="rules" ref="ruleForm2" label-width='120px'>
        <el-form-item label="回车时里程数" prop='fBackmileage'>
          <el-input v-model="form.fBackmileage" ></el-input>
        </el-form-item>
      </el-form>
      <div slot="footer" class="dialog-footer">
        <el-button size="mini" @click="dialogFormVisible = false"> <i class="iconfont icon-quxiao"></i>取 消</el-button>
        <el-button size="mini" type="primary" @click="recordConfirm"> <i class="iconfont icon-baocun"></i>确 定</el-button>
      </div>
    </el-dialog>
  </div>
</template>
    ...
    recordConfirm() {
      ...
      this.$refs.ruleForm2.validate(async valid => {
        if (valid) {
          ...
          updateData.fBackDate = new Date();
          updateData.fBacker = _this.user.userId;
          updateData.fBackmileage = this.form.fBackmileage;
