        ...
        >
          ...
          >
            <el-select
              ...
              :disabled="item.fReadOnly == 1 || item.fColumn == 'fStateName'"
              @focus.once="getAllData"
            >
              <el-pagination
  ...
  methods: {
    ...
    async getTableHeadData() {
      ...
      if (res.State) {
        ...
        this.$set(this.ruleForm, "fStateName", "初始");
    ...
    getVal(val, n) {
      ...
      //弹出框选择退货货品
      if (n == "fSupplierName" || n == "fSupplierCode") {
        this.$confirm("是否要选择退货商品", "提示", {
          confirmButtonText: "是",
          cancelButtonText: "否",
          type: "info"
        })
          .then(() => {
            this.$emit("openAlert", data);
          })
          .catch(() => {
            this.$message({
              type: "info",
