          ...
          <div class="number-keyboard-body">
            <ul class="list-wrap">
              <li
                ...
                v-for="i in 9"
                :key="i"
                @click="onKeyDown(keyNumberList[i-1], $event)"
              >{{keyNumberList[i-1]}}</li>
              <li
                class="list-item"
                :class="{'no-bg': isInteger}"
                @click="onKeyDown('.', $event)"
              >{{ isInteger ? '' : '.'}}</li>
              <li
                class="list-item"
                @click="onKeyDown(keyNumberList[9], $event)"
              >{{keyNumberList[9]}}</li>
              <li
                v-if="styleName=='popular'"
                class="list-item slidedown"
                @click="onSlideDown($event)"
              ></li>
...
module.exports = {
  ...
  methods: {
    ...
    computeFontSize() {
      this.fontSize = (
        ((document.body.clientWidth > 540 ? 540 : document.body.clientWidth) /
          375) *
        50
      ).toFixed(2);
    },
      ...
      .number-keyboard-body {
        ...
        .list-wrap {
          .list-item {
            ...
            &.delete {
              background: url("../../assets/img/keyboard-del-simple.png") center
                no-repeat;
              background-size: 0.82em;
            }

            &.slidedown {
              background: #fff url("../../assets/img/keyboard-hide.png") 50%
                no-repeat;
      ...
      .number-keyboard-operate {
        ...
        .list-wrap {
          ...
          .list-item {
            ...
            &.delete {
              background: #fff url("../../assets/img/keyboard-del-simple.png")
                50% no-repeat;
