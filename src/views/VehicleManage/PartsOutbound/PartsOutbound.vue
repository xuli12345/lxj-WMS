<template>
  <div>
    <HomeTable
      ...
      :tableName="'t_Parts_Outbound_Mst'"
...
export default {
  ...
  data() {
    return {
      ...
      batchDelTableName: [
        {
          Key: "t_Parts_Outbound_Item",
          Value: [{ Key: "fID", Value: "fMstID" }]
        }
      ],
      //表头的字段，以及自增长字段
      fTableViewHead: ["t_Parts_Outbound_Mst", "fID"],
      //表格的ftableview,自增长字段
      fTableViewItem: ["t_Parts_Outbound_Item", "fMstID"],
