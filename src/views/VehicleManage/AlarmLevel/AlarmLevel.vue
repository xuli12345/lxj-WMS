      ...
      selectArr:[
        {
          ...
          fAuto: ["fLevelID"],
          fAutoID: ["fLevelID"],
          searchWhere:[{Computer:"=",DataFile:"fParameterID",Value:3}]
        },
          {
          fName: "fPushGroupName",
          fUrl: "v_Parameter",
          fDes: "fParameterName",
          fID: "fID",
          fAuto: ["fPushGroupID"],
          fAutoID: ["fPushGroupID"],
          searchWhere:[{Computer:"=",DataFile:"fParameterID",Value:4}]
        }
      ]
    };
  },
